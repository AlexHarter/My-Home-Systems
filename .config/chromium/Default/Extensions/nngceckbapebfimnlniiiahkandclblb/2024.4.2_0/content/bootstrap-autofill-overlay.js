    ...
    constructor(domElementVisibilityService, autofillOverlayContentService) {
        ...
        this.buildAutofillFieldItem = (element, index) => collect_autofill_content_service_awaiter(this, void 0, void 0, function* () {
            ...
            if (elementIsSpanElement(element)) {
                ...
                void ((_a = this.autofillOverlayContentService) === null || _a === void 0 ? void 0 : _a.setupAutofillOverlayListenerOnField(element, autofillFieldBase));
            ...
            void ((_b = this.autofillOverlayContentService) === null || _b === void 0 ? void 0 : _b.setupAutofillOverlayListenerOnField(element, autofillField));
        ...
        this.handleFormElementIntersection = (entries) => collect_autofill_content_service_awaiter(this, void 0, void 0, function* () {
            ...
            for (let entryIndex = 0; entryIndex < entries.length; entryIndex++) {
                ...
                void ((_c = this.autofillOverlayContentService) === null || _c === void 0 ? void 0 : _c.setupAutofillOverlayListenerOnField(formFieldElement, cachedAutofillFieldElement));
