...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "Obsidian", "Neovim", "Brave", "Spotify", "Discord" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "Return", function () awful.spawn(terminal) end,
              {description = "open WezTerm", group = "launcher"}),
    awful.key({ modkey,           }, "d", function () awful.spawn("rofi -show drun") end,
              {description = "open Rofi", group = "launcher"}),
    awful.key({ modkey,           }, "n", function () awful.spawn("neovide") end,
              {description = "open Neovim", group = "launcher"}),
    awful.key({ modkey,           }, "b", function () awful.spawn(browser) end,
              {description = "open Brave", group = "launcher"}),
    --awful.key({ modkey,           }, "p", function () awful.spawn("wezterm -e ncspot") end,
